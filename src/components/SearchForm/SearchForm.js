...
const SearchForm = ({isShorts, setIsShorts}) => {
        ...
        <form className='search-form'>
            <div className='search-form__search-field'>
                <label className='search-form__label'>
                    ...
                    <input className='search-form__input-text' type='text' value={findValue} onChange={(e)=>setFindValue(e.target.value)} required placeholder='Фильм'/>
                </label>
